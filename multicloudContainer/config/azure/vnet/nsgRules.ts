export const nsgConfigs = [
  ...
  // NSG for Azure Container Apps Subnet
  {
    name: "azure-aca-nsg",
    subnetKeys: ["aca-subnet"],
    tags: { Purpose: "ContainerAppsSecurity" },
    rules: [
      {
        ...
        sourcePortRange: "*",
        destinationPortRange: "*",
        sourceAddressPrefix: "10.2.0.0/16", // AppGW Subnet CIDR
        destinationAddressPrefix: "*",
      },
      {
        name: "AllowInfrastructureInbound",
        priority: 105,
        direction: "Inbound",
        access: "Allow",
        protocol: "Tcp",
